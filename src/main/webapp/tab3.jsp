...
<html>
	<head>
		...
		<script type="text/javascript" charset="utf-8">
			...
			function updateRdd( ){
				var rrdLastTmp = document.getElementById("TextBoxDiv"+(rrdCounter-1));
				var rrdCounterTmp = rrdLastTmp.parentNode.childElementCount;
				...
				for ( var i=rrdCounterTmp ; i>2 ; i-- ){
						...
						var dbIdTmp = rrdLastTmp.parentNode.children[i-1].id;						
