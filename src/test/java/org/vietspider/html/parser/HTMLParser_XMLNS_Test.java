...
public class HTMLParser_XMLNS_Test  {
	private static final String TEST_HTML = "org/vietspider/html/parser/XMLNS.html";
	private static String HTML  =""; 
	private static HTMLDocument HDOC ;
	static{
		InputStream inRes = HTMLParser_XMLNS_Test.class.getClassLoader().getResourceAsStream(TEST_HTML);
	...
	public void testCreateDocumentString() throws Exception {
		...
		assertEquals(diffTmp.length, 1); // TODO 5 -> 0
