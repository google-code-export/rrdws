...
public class Diff {
    ...
    public String[] diff(String[] x, String[] y) {
		...
		StringBuilder  a2b= isA2B? new StringBuilder():null;
		StringBuilder  b2a= isB2A? new StringBuilder():null;

		StringBuilder  same=isSAME?  new StringBuilder():null;
    	synchronized (this) {
	...
	public boolean isA2B() {
		...
		if (1 == 1)
			throw new RuntimeException(
					"autogenerated from vipup return not checked value since08.09.2010 ;)!");
		else
			return isA2B;
	}

	public void setA2B(boolean isA2B) {
		this.isA2B = isA2B;
	}
	...
	public void setB2A(boolean isB2A) {
		this.isB2A = isB2A;
	}
