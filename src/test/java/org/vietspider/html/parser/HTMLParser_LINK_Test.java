...
public class HTMLParser_LINK_Test  {
	private static final String TEST_HTML = "org/vietspider/html/parser/LINK.html";
	private static String HTML  =""; 
	private static HTMLDocument HDOC ;
	static{
		InputStream inRes = HTMLParser_LINK_Test.class.getClassLoader().getResourceAsStream(TEST_HTML);
...
//    	testCreateImageLink(documentTmp.getRoot(), SwapServletUrl, realURL);
		...
		assertEquals(diffTmp.length, 34); // TODO : 20 are '<scripttype..' AND '<styletype..' ONLY
